...
public class PlayerController : MonoBehaviour, ICharacterController
{
    ...
    private void Update()
    {
        ...
        Vector2 inputMovement = inputManager.GetMovement();

        // Calculate move input vector based on head's forward and right directions
        Vector3 moveInputVector = (headForward * inputMovement.y + headRight * inputMovement.x).normalized;
            ...
            case CharacterState.Default:
                {
                    ...
                    // Jumping input
                    if (inputManager.IsJumpingThisFrame())
                    {
